...
public class ChatWindow extends Window implements ActionListener, WindowStateListener, OnDataReceivedListener /*, AdjustmentListener*/ {
    ...
    private static final String STYLE_SHEET = ".chat-box {margin: 2px;}" + ".chat-msg1 {border-radius:25px;background-color: #add8e6;padding: 7px; margin-top: 2px; margin-bottom: 2px; word-wrap: break-word;margin-right:50px;}"
    ...
    protected void initializeComponents() {
        ...
        inputField.setToolTipText("ISIKAN CHAT ANDA LALU DI KIRIM");
